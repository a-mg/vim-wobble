...
call wobble#MapTextObject('vato\e/class\r:noh\rF v2f\"'  , 'aC' , '+e')
call wobble#MapTextObject('vato\e/class\r:noh\rf\"lvi\"' , 'iC' , '+e')
...
call wobble#MapLocalLeader('vato<esc>/[ \>]<cr>:noh<cr>i class=""<esc>i' , 'iC')
